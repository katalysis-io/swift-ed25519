...
public func MakePublicKey(_ privateKeySeed: [byte]) -> [byte] {
    ...
    var digest = [UInt8](SHA512.hash(data: privateKeySeed))
...
public func Sign(_ privateKey: [byte], _ message: [byte]) -> [byte] {
    ...
    let digest1 = [UInt8](SHA512.hash(data: privateKeySeed))
    ...
    let messageDigest = [UInt8](SHA512.hash(data: data))
    ...
    let hramDigest = [UInt8](SHA512.hash(data: data))
...
public func Verify(_ publicKey: [byte], _ message: [byte], _ sig: [byte]) -> Bool {
    ...
    let digest = [UInt8](SHA512.hash(data: data))
